...
<p style='text-align: justify'>
An improved ESF model incorporating Inverter internal loading and parasitic circuit impedances should be developed to reduce the discrepancy between predicted and actual power dissipation values.
</p>
